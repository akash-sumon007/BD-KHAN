...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : ITZ AS 007'
    print 'FACEBOOK : facebook.com/itz.as007'
    print 'GITHUB     : github.com/itz-as007'
    print ''
    print 50* '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;96m[KHAN-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[ID OPEN ON 07 DAYS]\x1b[0m \n'
